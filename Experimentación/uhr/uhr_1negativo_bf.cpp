...
int main(int argc, char *argv[])
{
    ...
    std::vector<int> nodos_q = {50, 100, 200, 400, 600, 800, 1000, 1250, 1500, 1750, 2000};
    ...
    executed_runs = 0;
    for (int nodo_q : nodos_q) {
        mean_time = 0;
        time_stdev = 0;

        // Test configuration goes here
        Graph<double> grafo;
        CreateGraph::create_negative_graph(grafo, nodo_q, 10*nodo_q);
        ...
        time_data << nodo_q << "," << mean_time << "," << time_stdev << ",";
